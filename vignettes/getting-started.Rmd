...
at the end of the [The high-level interface](./high-level.html) vignette.
...
Some standard `R` commands are available (see the section "`Ryacas` high-level reference" at the end of the "[The high-level (symbol) interface](./high-level.html)" vignette):
...
To avoid floating-point issues (see the "[Arbitrary-precision arithmetic](./arbitrary-precision.html)" vignette), 
