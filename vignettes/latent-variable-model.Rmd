---
title: "The structure of the concentration and covariance matrix naive Bayes model"
author: "Mikkel Meyer Andersen and Søren Højsgaard"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{The structure of the concentration and covariance matrix naive Bayes model}
